...
function CreateHeroDamage(name, portrait)
    ...
    hero.extra_traits = {
		...
		UnitTrait.MineSweeper,              -- 扫雷者（工兵单位技能）：一次攻击即可清理雷区
...
- 【英雄】英雄是如何实现跨战役传递的？  -- 通过 SaveCore 和 core_sets 实现，新战役初始部队会被删除，继承的部队进入预备役，指挥官特质需要重选，不过建议每个战役拷贝一份英雄创建脚本
...
- 【缴获】缴获流什么兵种合适？          -- 依次为坦克、侦查、反坦克、步兵，建议加硬攻，侦察车移动性更好，弹药没必要，很难触发碾压，硬攻感觉12更合适
...
- 【缴获】缴获流不推荐带哪些技能？      -- 压路机单独没有用，碾压和俘获相冲，扫雷和火力压制相冲，多个双倍攻击不会叠加，缴获流对建筑没有歼灭流强势
- 【缴获】是否可以替换为纯缴获流？      -- 不建议，缴获流碾压不生效，持续作战能力不足
- 【缴获】伤害过高会影响缴获吗？        -- 有了火力压制后，急速攻击 和 整合者基本不影响伤害
- 【缴获】缴获流对飞机生效吗？          -- 飞机不能缴获，飞机攻击飞机不能缴获，飞机攻击地面也不能缴获

- 【ZOC】阶段性移动点数如何消耗?        -- 仍然按地形消耗移动点数，不对存在额外消耗，只是限制移动一格
- 【ZOC】免疫区域控制可以去掉？         -- 可以去掉，不影响移动范围，阶段性移动已经基本可以替代了，还能更容易区分战线
- 【ZOC】区域控制如何影响补给线？       -- 从“现实角度”来理解，你的补给线必须经过一个未被争夺的六边形格子，即敌方单位周边六格

- 【空战】飞机应该如何选？              -- 选战斗机或战术轰炸机即可，原则是各类攻击均衡即可，战略轰炸机类似于火炮，主要是压制伤害，不建议
- 【空战】低空攻击特质讲解？            -- 同时拥有低空特质的单位使用近身防御(一般为0)结算伤害，战斗机、战术轰炸机、20mm防空炮都有该特性，因而可以克制飞机
- 【空战】防空老兵这个特质如何？        -- 并不需要，防空炮除了对空攻击，其它伤害只能用于反击，不能代替火炮

- 【特质】好运连连加的是什么攻击？      -- 任意类型攻击，属性面板不显示，在战斗计算时生效
- 【特质】免疫包围可以去掉？            -- 包围谨慎一些、注意侦查和战线即可，其负面也只是弹药和补给
- 【特质】免疫伏击和机警可以去掉？      -- 实际体验下来，免疫伏击还是需要的，容易碰到地雷，视野开图感觉比近身防御重要，因而机警也是需要的
- 【特质】免疫反击和现场维修可以去掉？  -- 偶尔的被敌方残血反击无伤大雅，部署阶段维修即可，不太影响战力，也不差钱，歼灭流基本不会被反击，免疫反击对俘获流影响更大
- 【特质】免核心特质是否需要？          -- 8坦4空，核心减半情况下，基础版26、强化版50~62、顶配版88，在可控范围内，因而核心减半即可
```
...
-- 特质类: 预定义效果的特质，除了已经应用的，此处补充一些常用的
hero.extra_traits = {{
    -- 伤害类
